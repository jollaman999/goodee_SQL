...
values(1001,'김유태','kyt','정교수',550,str_to_date('2011-10-01','%Y-%m-%d'),200,101,'kyt@abc.net','http://www.kytpage.net');

insert into professor
values(1002,'김경빈','kkb','정교수',450,str_to_date('2014-01-01','%Y-%m-%d'),100,102,'kkb@abc.net','http://www.kkbpage.net');

insert into professor
values(1003,'이영택','lyt','정교수',400,str_to_date('2014-01-01','%Y-%m-%d'),100,103,'lyt@abc.net','http://www.lytpage.net');

insert into professor
values(1004,'이복영','lby','조교수',350,str_to_date('2016-10-01','%Y-%m-%d'),100,101,'lby@abc.net','http://www.lbypage.net');

insert into professor
values(1005,'조황섭','chs','조교수',300,str_to_date('2017-03-01','%Y-%m-%d'),100,102,'chs@abc.net','http://www.chspage.net');

insert into professor
values(1006,'송승환','ssh','조교수',350,str_to_date('2015-03-01','%Y-%m-%d'),100,103,'ssh@abc.net','http://www.sshpage.net');

insert into professor
values(1007,'이상미','lsm','조교수',400,str_to_date('2015-03-01','%Y-%m-%d'),100,201,'lsm@abc.net','http://www.lsmpage.net');
 
insert into professor
values(1008,'조미영','cmy','조교수',430,str_to_date('2015-03-01','%Y-%m-%d'),100,202,'cmy@abc.net','http://www.cmypage.net');


insert into professor
values(1009,'박인숙','pis','조교수',512,str_to_date('2015-03-01','%Y-%m-%d'),100,101,'pis@abc.net','http://www.pispage.net');


insert into professor
values(5010,'김옥남','kon','시간강사',280,str_to_date('2015-03-01','%Y-%m-%d'),NULL,102,'kon@abc.net','http://www.konpage.net');


insert into professor
values(5011,'김현정','khj','시간강사',355,str_to_date('2015-03-01','%Y-%m-%d'),NULL,103,'khj@abc.net','http://www.khjpage.net');


insert into professor
values(5013,'이명정','lmj','시간강사',200,str_to_date('2015-03-01','%Y-%m-%d'),NULL,301,'lmj@abc.net','http://www.lmjpage.net');

insert into professor
values(5014,'이정미','ljm','시간강사',250,str_to_date('2015-03-01','%Y-%m-%d'),NULL,201,'ljm@abc.net','http://www.ljmpage.net');

insert into professor
values(5015,'박성신','pss','시간강사',150,str_to_date('2015-03-01','%Y-%m-%d'),NULL,202,'pss@abc.net','http://www.psspage.net');
